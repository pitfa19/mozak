...
fn run_distribution_command(args: &[String]) -> Option<Result<ExitCode, String>> {
    match args {
        ...
        [setup, command, home] if setup == "setup" => {
            Some(distribution::setup(command, Path::new(home)))
        }
